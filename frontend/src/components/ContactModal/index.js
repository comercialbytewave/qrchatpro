            ...
            <Form>
                  ...
                  <FormControl margin="dense" variant="outlined" fullWidth>
                    ...
                    <Paper className={classes.mainPaper} variant="outlined">
                      <Table size="small">
                        ...
                        <TableBody>
                          <TableRow key={contact?.customer.id}>
                            <TableCell>{contact?.customer.document}</TableCell>
                            <TableCell align="center">
                            ...
                            <TableCell align="center">
                              <IconButton
                                size="small"
                                onClick={(e) =>
                                  handleOpenCustomerModal(contact.id)
                                }
                              >
                                <Edit />
                              </IconButton>
                              <IconButton
                                size="small"
                                onClick={(e) => handleRemoveContact(contact.id)}
                              >
                                <Close />
                              </IconButton>
                            </TableCell>
              ...
              <DialogActions>
                <Button
                  color="secondary"
                  variant="contained"
                  disabled={!contactId || contact?.customer?.id}
                  className={classes.btnWrapper}
                  onClick={(e) => handleOpenCustomerModal(contact.id)}
                >
                  {`${i18n.t("customerModal.buttons.customer")}`}
                </Button>
                <Button
                  onClick={handleClose}
                  color="secondary"
